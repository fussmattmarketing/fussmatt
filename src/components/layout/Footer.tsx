      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-start lg:items-end gap-4">
            {/* Payment badge — Stripe only, no third-party image
                (the old payment-methods.webp included a TWINT logo that
                no longer matches what the gateway actually accepts) */}
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-lg bg-gray-900 border border-gray-800">
              <svg
