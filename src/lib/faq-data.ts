...
export const FAQ_ITEMS: FAQItem[] = [
 ...
 a: "Wir verwenden hochwertiges TPE (Thermoplastisches Elastomer): geruchsarm, rutschfest, langlebig und recyclebar. Das Material bleibt flexibel von −40 °C bis +80 °C.",
  },
  {
 q: "Sind die Matten wasserdicht?",
 a: "Ja, alle FussMatt-Matten sind wasserdicht. Die erhöhten Ränder schützen den Fussraum zuverlässig vor Wasser, Schnee und Schmutz.",
  },
  {
