  ...
  return {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: `Ja, alle unsere Fussmatten bestehen aus hochwertigem TPE-Material (Thermoplastisches Elastomer) und sind zu 100% wasserdicht. Das Material ist zudem geruchlos, umweltfreundlich und flexibel von -40°C bis +80°C.`,
      },
      {
...
export function generateCategoryBrandModelContent(
  ...
  const introVariants = [
    `Finden Sie die perfekten ${categoryName} für Ihren ${brandName} ${modelName}. ${catDesc}. ${countText}Jede Matte wird per 3D-Vermessung exakt für den ${brandName} ${modelName} gefertigt — aus hochwertigem TPE-Material, 100% wasserdicht und rutschfest. Schützen Sie den Innenraum Ihres ${modelName} zuverlässig vor Schmutz, Nässe und Verschleiss.`,
  ...
  return {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: `Ja, alle unsere Fussmatten bestehen aus TPE-Material (Thermoplastisches Elastomer) und sind zu 100% wasserdicht, rutschfest und geruchlos. Das Material bleibt flexibel von -40°C bis +80°C.`,
      },
      {
  ...
  return {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer: `Ja, alle unsere Fussmatten bestehen aus hochwertigem TPE-Material und sind zu 100% wasserdicht, rutschfest und extrem langlebig. Erhöhte Ränder schützen den gesamten Fussraum.`,
      },
      {
        question: `Was ist der Unterschied zwischen 3D und 5D Fussmatten für den ${brandName} ${modelName}?`,
