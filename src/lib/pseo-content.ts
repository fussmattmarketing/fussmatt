  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        text: "Kostenloser Versand in der ganzen Schweiz — ohne Mindestbestellwert. Lieferung in 1–3 Werktagen. 30 Tage Rückgaberecht auf alle Fussmatten. Bezahlung mit Stripe (Kreditkarte).",
      },
    ],
    faqItems: [
      {
