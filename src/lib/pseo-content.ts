...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  "5d-fussmatten":
    "5D Premium Fussmatten bieten maximalen Schutz durch erhöhte Seitenränder, die den gesamten Fussraum abdecken",
  "3d-fussmatten":
    "3D Fussmatten mit geformten Rändern schützen den Fahrzeugboden zuverlässig vor Schmutz und Feuchtigkeit",
 kofferraummatte:
    "Kofferraummatten schützen Ihren Kofferraum effektiv vor Kratzern, Schmutz und Flüssigkeiten",
  "universal-fussmatten":
    "Universal Fussmatten sind vielseitig einsetzbar und passen sich verschiedenen Fahrzeugmodellen an",
  "fussmatten-set":
    "Komplette Fussmatten-Sets bieten Rundumschutz für alle Sitzreihen Ihres Fahrzeugs",
};
...
export function generateCategoryBrandContent(
 ...
 const introVariants = [
    `Entdecken Sie unsere Premium ${categoryName} speziell für ${brandName} Fahrzeuge. ${catDesc}. Unsere ${countStr}${brandName} Fussmatten werden per 3D-Vermessung millimetergenau gefertigt und bestehen aus hochwertigem TPE-Material — wasserdicht, rutschfest und extrem langlebig.`,
    ...
    `Schützen Sie Ihren ${brandName} mit hochwertigen ${categoryName}. ${catDesc}. Dank 3D-Vermessung passt jede Matte millimetergenau in Ihr Fahrzeug.${countStr ? ` Aktuell ${countStr}Produkte für ${brandName} verfügbar.` : ""} wasserdicht, rutschfest und langlebig.`,
  ];
 ...
 metaDescription: `Premium ${categoryName} für ${brandName}. Massgefertigt per 3D-Vermessung, wasserdicht und rutschfest. Jetzt bei FussMatt bestellen.`,
 faqItems: [
      {
 ...
 answer: `Ja, alle unsere Fussmatten bestehen aus hochwertigem TPE-Material (Thermoplastisches Elastomer) und sind wasserdicht. Das Material ist zudem geruchlos, umweltfreundlich und flexibel von -40°C bis +80°C.`,
      },
      {
 question: `Wie pflege ich die ${brandName} Fussmatten?`,
...
export function generateCategoryBrandModelContent(
 ...
 const introVariants = [
    `Finden Sie die perfekten ${categoryName} für Ihren ${brandName} ${modelName}. ${catDesc}. ${countText}Jede Matte wird per 3D-Vermessung exakt für den ${brandName} ${modelName} gefertigt — aus hochwertigem TPE-Material, wasserdicht und rutschfest. Schützen Sie den Innenraum Ihres ${modelName} zuverlässig vor Schmutz, Nässe und Verschleiss.`,
    ...
    `${categoryName} speziell für den ${brandName} ${modelName} — millimetergenau, wasserdicht und extrem strapazierfähig. ${catDesc}. ${countText}Unsere Matten bestehen aus Premium-TPE und schützen den Fussraum Ihres ${modelName} zuverlässig vor Schmutz und Feuchtigkeit.`,
  ];
 ...
 answer: `Unsere ${categoryName} werden per 3D-Vermessung exakt für den ${brandName} ${modelName} gefertigt. Sie passen millimetergenau — kein Zuschneiden nötig. Wählen Sie Ihr Baujahr für die perfekte Passform.`,
      ...
      {
 question: `Was ist der Unterschied zwischen 3D und 5D Fussmatten für den ${brandName} ${modelName}?`,
 answer: `3D Fussmatten bieten geformte Ränder für zuverlässigen Grundschutz. 5D Premium Fussmatten haben zusätzlich erhöhte Seitenränder, die den gesamten Fussraum Ihres ${brandName} ${modelName} abdecken — ideal für maximalen Schutz bei jedem Wetter.`,
      },
      {
 question: `Sind die ${categoryName} für ${brandName} ${modelName} wasserdicht?`,
 answer: `Ja, alle unsere Fussmatten bestehen aus TPE-Material (Thermoplastisches Elastomer) und sind wasserdicht, rutschfest und geruchlos. Das Material bleibt flexibel von -40°C bis +80°C.`,
      },
      {
...
export function generateBrandGuideContent(
 ...
 text: `Jedes ${brandName} Modell hat einzigartige Fussraum-Masse. Universal-Matten hinterlassen unbedeckte Stellen und rutschen. Unsere ${brandName} Fussmatten werden per 3D-Vermessung exakt an die Konturen jedes Modells angepasst — für lückenlosen Schutz ohne Kompromisse.`,
      },
      {
 heading: "3D vs 5D Fussmatten im Vergleich",
 text: `Beide Varianten bestehen aus hochwertigem TPE-Material. 3D Fussmatten bieten erhöhte Ränder (3-5 cm) für soliden Basisschutz. 5D Premium Matten gehen weiter: Bis zu 8 cm hohe Ränder decken den gesamten Fussraum ab — auch die Seiten. Für ${brandName} Fahrer, die maximalen Schutz wollen, empfehlen wir die 5D Variante.`,
      },
      {
 ...
 text: "Unsere Fussmatten bestehen aus Thermoplastischem Elastomer (TPE): wasserdicht, rutschfest, geruchlos und UV-beständig. Das Material bleibt flexibel von -40°C bis +80°C und ist recycelbar — eine umweltfreundliche Alternative zu PVC oder Gummi.",
      },
      {
 heading: "Bestellung, Versand & Rückgabe",
 text: "Kostenloser Versand in der ganzen Schweiz — ohne Mindestbestellwert. Lieferung in 1–3 Werktagen. 30 Tage Rückgaberecht auf alle Fussmatten. Bezahlung sicher über Stripe — Visa, Mastercard und American Express.",
      },
    ],
 faqItems: [
      {
...
export function generateModelYearContent(
 ...
 const introVariants = [
    `Passgenaue Fussmatten für Ihren ${brandName} ${modelName} (Baujahr ${yearLabel}). Unsere Premium Fussmatten werden per 3D-Vermessung millimetergenau für Ihr Fahrzeug gefertigt.${countSuffix} Hochwertiges TPE-Material sorgt für maximalen Schutz vor Schmutz, Wasser und Verschleiss — bei jedem Wetter.`,
    `Ihr ${brandName} ${modelName} (${yearLabel}) verdient perfekten Bodenschutz. Unsere Fussmatten werden exakt per 3D-Vermessung für dieses Baujahr gefertigt — kein Zuschneiden, keine Lücken.${countSuffix} Wasserdichtes TPE-Material schützt bei Regen, Schnee und Schmutz.`,
    `Massgefertigte Fussmatten für den ${brandName} ${modelName}, Baujahr ${yearLabel}. Per 3D-Scan an die exakten Konturen Ihres Fahrzeugs angepasst.${countSuffix} Premium TPE-Material: wasserdicht, rutschfest und temperaturbeständig von -40°C bis +80°C.`,
  ];

 return {
 h1: `${brandName} ${modelName} Fussmatten (Baujahr ${yearLabel})`,
 introText: pickVariant(introVariants, brandName, modelName, yearLabel),
 metaTitle: `${brandName} ${modelName} Fussmatten Baujahr ${yearLabel} | FussMatt`,
 metaDescription: `Passgenaue Fussmatten für ${brandName} ${modelName} (${yearLabel}). Premium TPE-Material, wasserdicht, massgefertigt. Jetzt bei FussMatt bestellen.`,
 faqItems: [
      {
 question: `Welche Fussmatten passen zum ${brandName} ${modelName} (${yearLabel})?`,
 answer: `Unsere Fussmatten sind millimetergenau für den ${brandName} ${modelName} (Baujahr ${yearLabel}) gefertigt. Sie werden per 3D-Vermessung passgenau hergestellt und passen exakt in Ihr Fahrzeug — ohne Zuschneiden.`,
      },
      {
 question: `Sind die Fussmatten für ${brandName} ${modelName} wasserdicht?`,
 answer: `Ja, alle unsere Fussmatten bestehen aus hochwertigem TPE-Material und sind wasserdicht, rutschfest und extrem langlebig. Erhöhte Ränder schützen den gesamten Fussraum.`,
      },
      {
 question: `Was ist der Unterschied zwischen 3D und 5D Fussmatten für den ${brandName} ${modelName}?`,
 answer: `3D Fussmatten haben geformte Ränder für grundlegenden Schutz. 5D Premium Fussmatten bieten zusätzlich erhöhte Seitenränder, die den gesamten Fussraum abdecken — ideal für maximalen Schutz in Ihrem ${brandName} ${modelName}.`,
      },
      {
